 ...
 */
final class Version20240424213243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pack (id SERIAL NOT NULL, code UUID DEFAULT uuid_generate_v4() NOT NULL, price NUMERIC(6, 3) NOT NULL, description TEXT NOT NULL, free_trial_period INT NOT NULL, subscription_period INT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subscription (id INT NOT NULL, transporter_id INT NOT NULL, pack_id INT NOT NULL, code UUID DEFAULT uuid_generate_v4() NOT NULL, expiration_date TIMESTAMP(0) WITH TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A3C664D34F335C8B ON subscription (transporter_id)');
        $this->addSql('CREATE INDEX IDX_A3C664D31919B217 ON subscription (pack_id)');
        $this->addSql('COMMENT ON COLUMN subscription.code IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE wording (id SERIAL NOT NULL, domain_id INT DEFAULT NULL, code VARCHAR(100) NOT NULL, label VARCHAR(100) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE wording_translation (id SERIAL NOT NULL, wording_id INT DEFAULT NULL, content VARCHAR(200) NOT NULL, language VARCHAR(2) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE subscription ADD CONSTRAINT FK_A3C664D34F335C8B FOREIGN KEY (transporter_id) REFERENCES transporter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE subscription ADD CONSTRAINT FK_A3C664D31919B217 FOREIGN KEY (pack_id) REFERENCES pack (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subscription DROP CONSTRAINT FK_A3C664D34F335C8B');
        $this->addSql('ALTER TABLE subscription DROP CONSTRAINT FK_A3C664D31919B217');
